...
#print df2.head(10) 10 rows x 56 columns
...
accuracy_train =[]
def nbc(t_frac, df1, df2): #Naive Bayes 
	sampling = df1.sample(frac=t_frac, random_state = 47) #training sample
...
for i in range (0,len(f)):
	print "f: ", f[i]
	accuracy_train, accuracy_test = nbc(f[i], df1, df2)
