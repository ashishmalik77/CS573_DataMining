...
#.................. DT ................#
'''
test_set_3 = pd.DataFrame(S1)
#print "S1", S1, type(S1), type(test_set_3), test_set.shape # array (260, 50)

#train_set_union = np.array( [S2 , S3 , S4 , S5 , S6 , S7 , S8 , S9 , S10])
train_set_union_3 = np.concatenate((S2 , S3 , S4 , S5 , S6 , S7 , S8 , S9 , S10), axis=0) 
#print "train_set_union",train_set_union_3, len(train_set_union_3), type (train_set_union), train_set_union.shape #ok
train_set_union_df_3 = pd.DataFrame(train_set_union_3) #convert Numpy ndarray to pandas dataframe
#print "train_set_union_df", train_set_union_df_3, train_set_union_df_3.shape, type(train_set_union_df_3) #ok  (2340, 50) 
label_train_3 = train_set_union_df_3.values[0:, 49:50]
label_test_3 = test_set_3.values[0:, 49:50]
'''
##########....>>>>>>DT.............##########
avg_accuracy_train_DT = []
std_accuracy_train_DT = []
sterr_train_DT = []
avg_accuracy_test_DT = []
std_accuracy_test_DT = []
sterr_test_DT = []

for i in depth:
    accuracy_train_DT_arr = []
    accuracy_test_DT_arr = []
    for j in range (1,11):
        train_set, test_set = union_trainset(j, S1, S2 , S3 , S4 , S5 , S6 , S7 , S8 , S9 , S10)
        label_train_3 = train_set.values[0:, 49:50]
        label_test_3 = test_set.values[0:, 49:50]
        predictions_train_cv_3, predictions_test_cv_3 = decision_tree(train_set.values.tolist(), test_set.values.tolist(), i, 50)
        #print i, type(i)
        #predictions_train_cv_3, predictions_test_cv_3 = decision_tree(train_set_union_df_3.values.tolist(), test_set_3.values.tolist(), i, 50)
        #train_accuracy_DT_3 = calculate_accuracy(predictions_train_cv_3, label_train_3)
        #accu_train_arr_3.append(train_accuracy_DT_3)
        #test_accuracy_DT_3 = calculate_accuracy(predictions_test_cv_3, label_test_3)
        #accu_test_arr_3.append(test_accuracy_DT_3)
        train_accuracy_DT_3 = calculate_accuracy(predictions_train_cv_3, label_train_3)
        accuracy_train_DT_arr.append(train_accuracy_DT_3)
        test_accuracy_DT_3 = calculate_accuracy(predictions_test_cv_3, label_test_3)
        accuracy_test_DT_arr.append(test_accuracy_DT_3)

    avg_accuracy_train_DT.append((np.mean(accuracy_train_DT_arr)))
    std_accuracy_train_DT.append(np.std(accuracy_train_DT_arr))
    avg_accuracy_test_DT.append((np.mean(accuracy_test_DT_arr)))
    std_accuracy_test_DT.append(np.std(accuracy_test_DT_arr))

for i in range (0,len(std_accuracy_train_DT)):
    sterr_train_DT.append(float(std_accuracy_train_DT[i])/trial)
    sterr_test_DT.append(float(std_accuracy_test_DT[i])/trial)



'''
print "avg_accuracy_train_DT", avg_accuracy_train_DT
print "std_accuracy_train_DT", std_accuracy_train_DT
print "sterr_train_DT", sterr_train_DT
print "avg_accuracy_test_DT (validation accuracy)", avg_accuracy_test_DT
print "std_accuracy_test_DT", std_accuracy_test_DT
print "sterr_test_DT", sterr_test_DT
'''
...
for i in depth:
    ...
    for j in range (1,11):
        train_set, test_set = union_trainset(j, S1, S2 , S3 , S4 , S5 , S6 , S7 , S8 , S9 , S10)
        predictions_train_cv_4, predictions_test_cv_4 = bagging(train_set.values.tolist(), test_set.values.tolist(), i, 50, n_trees)
...
#.................. RF ................#
'''
cv_rf_accu_train_arr_3 = []
cv_rf_accu_test_arr_3 = []
for i in depth:
    train_accuracy_cv_RF, predictions_test_cv_RF = random_forest(train_set_union_df_3.values.tolist(), test_set_3.values.tolist(), i, 50, sample_size_RF, n_trees, n_features)
    train_accuracy_RF_3 = calculate_accuracy(train_accuracy_cv_RF, label_train_3)
    cv_rf_accu_train_arr_3.append(train_accuracy_RF_3)
    test_accuracy_RF_3 = calculate_accuracy(predictions_test_cv_RF, label_test_3)
    cv_rf_accu_test_arr_3.append(test_accuracy_RF_3)
 
print "CV RF train", cv_rf_accu_train_arr_3, len(cv_rf_accu_train_arr_3)
print "CV RF test", cv_rf_accu_test_arr_3, len(cv_rf_accu_test_arr_3)
'''
...
for i in depth:
    ...
    for j in range (1,11):
        train_set, test_set = union_trainset(j, S1, S2 , S3 , S4 , S5 , S6 , S7 , S8 , S9 , S10)
        predictions_train_cv_4, predictions_test_cv_4 = random_forest(train_set.values.tolist(), test_set.values.tolist(), i, 50, n_trees, n_features)
        label_train_4 = train_set.values[0:, 49:50]
        label_test_4 = test_set.values[0:, 49:50]
...
print "p value BT and RF for depth of trees 3 : ", p_value1
print "p value BT and RF for depth of trees 5 : ", p_value2
print "p value BT and RF for depth of trees 7 : ", p_value3
print "p value BT and RF for depth of trees 9 : ", p_value4

'''
print "avg_accuracy_train_RF", avg_accuracy_train_RF
print "std_accuracy_train_RF", std_accuracy_train_RF
print "sterr_train_RF", sterr_train_RF
print "avg_accuracy_test_RF (validation accuracy)", avg_accuracy_test_RF
print "std_accuracy_test_RF", std_accuracy_test_RF
print "sterr_test_RF", sterr_test_RF
'''
...
plt.errorbar(depth, avg_accuracy_test_DT, yerr=sterr_test_DT, marker='o', color='blue',ecolor='gray',elinewidth=1, capsize=2, barsabove = True, label='Validation Accuracy DT')
plt.errorbar(depth, avg_accuracy_test_BT, yerr=sterr_test_BT, marker='o', color='green',ecolor='purple',elinewidth=1, capsize=2, barsabove = True, label='Validation Accuracy BT')
plt.errorbar(depth, avg_accuracy_test_RF, yerr=sterr_test_RF, marker='o', color='red',ecolor='black',elinewidth=1, capsize=2, barsabove = True, label='Validation Accuracy RF')
