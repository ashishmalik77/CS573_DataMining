...
if modelIdx == '1': #LR
	...
	weights = logistic_regression(train_features, train_labels, num_steps = 5000, learning_rate = 0.05, add_intercept=True)
...
if modelIdx == '2': #Linear SVM
	...
	weights = svm(train_features, train_labels, num_steps2 = 500, learning_rate = 0.7, add_intercept=False)
